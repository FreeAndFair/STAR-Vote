...
export STAR_POST_VOTE_URL=http://localhost:8000/fillOut
export STAR_REGISTER_URL=http://localhost:8000/registerTerminal

dist/build/star-terminal/star-terminal -p 8001
